...
function setup() {
    ...
    buttons.push(new button(width*0.05, height*0.55, width/80, height * 0.04, "./word-wizard", "Word Wizard: Flash is dead. Long live Anagram Magic (Comissioned by my sister)"))
