...
const meta = //this is worst-formatted variable you've ever seen
//instructions
...
}, {instruction: 'MUL_REG_LIT' , opcode:  0x22, type: instructionTypes.regLit, size: instructionTypeSizes.regLit, mnemonic: 'mul'  // REG LITERAL
...
//0x3X: Branching
}, {instruction: 'JMP'         , opcode:  0x30, type: instructionTypes.singleLit, size: instructionTypeSizes.singleMem, mnemonic: 'jmp'  // LITERAL
}, {instruction: 'JEZ'         , opcode:  0x31, type: instructionTypes.singleLit, size: instructionTypeSizes.singleMem, mnemonic: 'jez'  // LITERAL
}, {instruction: 'JLZ'         , opcode:  0x32, type: instructionTypes.singleLit, size: instructionTypeSizes.singleMem, mnemonic: 'jlz'  // LITERAL
}, {instruction: 'JGZ'         , opcode:  0x33, type: instructionTypes.singleLit, size: instructionTypeSizes.singleMem, mnemonic: 'jgz'  // LITERAL
}, {instruction: 'JNZ'         , opcode:  0x34, type: instructionTypes.singleLit, size: instructionTypeSizes.singleMem, mnemonic: 'jnz'  // LITERAL
}, {instruction: 'JNE_LIT'     , opcode:  0x35, type: instructionTypes.litLit, size: instructionTypeSizes.litMem, mnemonic: 'jne'  // LITERAL LITERAL
}, {instruction: 'JNE_REG'     , opcode:  0x36, type: instructionTypes.regLit, size: instructionTypeSizes.regMem, mnemonic: 'jne'  // LITERAL LITERAL
}, {instruction: 'JLT_LIT'     , opcode:  0x37, type: instructionTypes.litLit, size: instructionTypeSizes.litMem, mnemonic: 'jlt'  // LITERAL LITERAL
}, {instruction: 'JLT_REG'     , opcode:  0x38, type: instructionTypes.regLit, size: instructionTypeSizes.regMem, mnemonic: 'jlt'  // LITERAL LITERAL
}, {instruction: 'JGT_LIT'     , opcode:  0x39, type: instructionTypes.litLit, size: instructionTypeSizes.litMem, mnemonic: 'jgt'  // LITERAL LITERAL
}, {instruction: 'JGT_REG'     , opcode:  0x3a, type: instructionTypes.regLit, size: instructionTypeSizes.regMem, mnemonic: 'jgt'  // LITERAL LITERAL
}, {instruction: 'JEQ_LIT'     , opcode:  0x3b, type: instructionTypes.litLit, size: instructionTypeSizes.litMem, mnemonic: 'jeq'  // LITERAL LITERAL
}, {instruction: 'JEQ_REG'     , opcode:  0x3c, type: instructionTypes.regLit, size: instructionTypeSizes.regMem, mnemonic: 'jeq'  // LITERAL LITERAL
