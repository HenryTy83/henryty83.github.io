...
cal &NUL, [!_function-draw_splash_screen]

cal $0a, [!_function-sleep]
...
_function-draw_splash_screen:
mov &x, acc
inc x
inc x
jez [!_function-draw_splash_screen-end]
mov acc, &y
inc y
jmp [!_function-draw_splash_screen]

_function-draw_splash_screen-end:
rts

_function-sleep:
mov &FP, d
mov [!_memory_map-sleep_timer], acc
jlt d, [!_function-sleep]
rts
